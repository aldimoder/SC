...
const client = makeWaSocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["SC Simple By XYZZ BOTZ", "Dekstop", "3.0"]})
console.log(color('[ SC BY ZiroMD ]\n', 'red'),color('\nInfo Script :\n➸ Baileys : Multi Device\n➸ Nama Script : XYZZ BOTZ\n➸ Creator : ZIRO\n\nFollow My Social Media Account All Yes :\n➸ My Youtube : XYZZ BOTZ OFFICIAL`\n➸ My Instagram : @ziro_md\n\nDonase Me For Support :\n➸ DONASI : https://saweria.co/ZiroMD\n\nThanks\n', 'red'))
