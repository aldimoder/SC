...
const client = makeWASocket({ logger: pino ({ level: 'silent' }), printQRInTerminal: true, auth: state, browser: ["SC Simple By Dayy", "Dekstop", "3.0"]})
console.log(color('[ SC BY Xyzz -MD ]\n', 'red'),color('\nInfo Script :\n➸ Baileys : Multi Device\n➸ Nama Script : Xyzz -MD\n➸ Creator : Dayy\n\nFollow My Social Media Account All Yes :\n➸ My Youtube : Xyzz -MD OFFICIAL`\n➸ My Instagram : @devv.dayy\n\nThanks\n', 'red'))
